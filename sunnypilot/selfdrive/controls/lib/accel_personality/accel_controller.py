...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.002, -0.002, -0.006, -0.40, -1.2, -1.2],
  AccelPersonality.normal: [-0.003, -0.003, -0.007, -0.42, -1.2, -1.3],
  AccelPersonality.sport:  [-0.005, -0.005, -0.008, -0.44, -1.3, -1.4],
}
