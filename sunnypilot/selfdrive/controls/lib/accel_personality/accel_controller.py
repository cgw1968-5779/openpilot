...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.01, -0.01, -0.030, -0.36, -1.2, -1.2],
  AccelPersonality.normal: [-0.01, -0.01, -0.015, -0.37, -1.2, -1.3],
  AccelPersonality.sport:  [-0.01, -0.01, -0.009, -0.37, -1.3, -1.4],
}
