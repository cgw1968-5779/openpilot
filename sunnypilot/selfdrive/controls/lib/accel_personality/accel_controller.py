...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.004, -0.004, -0.004, -0.50, -1.2, -1.2],
  AccelPersonality.normal: [-0.005, -0.005, -0.005, -0.52, -1.2, -1.3],
  AccelPersonality.sport:  [-0.007, -0.007, -0.006, -0.54, -1.3, -1.4],
}
