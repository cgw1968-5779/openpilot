...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.2, -0.3, -0.4, -0.5, -1.2, -1.2],
  AccelPersonality.normal: [-0.3, -0.4, -0.5, -0.6, -1.2, -1.3],
  AccelPersonality.sport:  [-0.4, -0.5, -0.6, -0.7, -1.3, -1.4],
}
MIN_ACCEL_BREAKPOINTS =    [3,     3.5,   7.,   9.,   14.,   25]
