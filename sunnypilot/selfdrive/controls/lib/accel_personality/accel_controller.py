...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.01, -0.01, -0.006, -0.34, -1.2, -1.2],
  AccelPersonality.normal: [-0.01, -0.01, -0.007, -0.36, -1.2, -1.3],
  AccelPersonality.sport:  [-0.02, -0.02, -0.008, -0.38, -1.3, -1.4],
}
