...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-1., -0.04, -0.04, -0.4, -0.5, -0.6, -1.2, -1.2],
  AccelPersonality.normal: [-1., -0.06, -0.06, -0.5, -0.6, -0.7, -1.2, -1.3],
  AccelPersonality.sport:  [-1., -0.08, -0.08, -0.6, -0.7, -0.8, -1.3, -1.4],
}
