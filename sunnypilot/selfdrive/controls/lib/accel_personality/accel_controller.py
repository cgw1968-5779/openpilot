...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-1., -0.003, -0.003, -0.3, -0.4, -0.5, -1.2, -1.2],
  AccelPersonality.normal: [-1., -0.004, -0.004, -0.4, -0.5, -0.6, -1.2, -1.3],
  AccelPersonality.sport:  [-1., -0.005, -0.005, -0.5, -0.6, -0.7, -1.3, -1.4],
}
MIN_ACCEL_BREAKPOINTS =    [0.,  0.01,   3,      4.5,   7.,   9.,   14.,   25]
