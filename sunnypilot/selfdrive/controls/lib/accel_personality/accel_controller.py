...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-1., -0.01, -0.01, -0.3, -0.4, -0.5, -1.2, -1.2],
  AccelPersonality.normal: [-1., -0.02, -0.02, -0.4, -0.5, -0.6, -1.2, -1.3],
  AccelPersonality.sport:  [-1., -0.03, -0.03, -0.5, -0.6, -0.7, -1.3, -1.4],
}
