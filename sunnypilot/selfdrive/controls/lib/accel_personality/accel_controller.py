...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.004, -0.004, -0.030, -0.36, -1.2, -1.2],
  AccelPersonality.normal: [-0.005, -0.005, -0.015, -0.37, -1.2, -1.3],
  AccelPersonality.sport:  [-0.006, -0.006, -0.009, -0.37, -1.3, -1.4],
}
