...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.002, -0.002, -0.025, -0.36, -1.2, -1.2],
  AccelPersonality.normal: [-0.003, -0.003, -0.015, -0.37, -1.2, -1.3],
  AccelPersonality.sport:  [-0.004, -0.004, -0.009, -0.37, -1.3, -1.4],
}
