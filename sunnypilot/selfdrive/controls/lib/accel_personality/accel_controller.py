...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-1.2, -0.06, -0.06, -0.32, -0.42, -0.52, -1.2, -1.2],
  AccelPersonality.normal: [-1.3, -0.07, -0.07, -0.34, -0.44, -0.54, -1.2, -1.3],
  AccelPersonality.sport:  [-1.4, -0.08, -0.08, -0.36, -0.46, -0.56, -1.3, -1.4],
}
