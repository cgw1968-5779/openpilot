...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-1., -0.04, -0.04, -0.3, -0.4, -0.5, -1.2, -1.2],
  AccelPersonality.normal: [-1., -0.06, -0.06, -0.4, -0.5, -0.6, -1.2, -1.3],
  AccelPersonality.sport:  [-1., -0.08, -0.08, -0.5, -0.6, -0.7, -1.3, -1.4],
}
MIN_ACCEL_BREAKPOINTS =    [0.,  0.001,  3,    4.5,  7.,   9.,   14.,  25]


DECEL_SMOOTH_ALPHA = 0.20  # Very aggressive smoothing for decel (lower = smoother)
ACCEL_SMOOTH_ALPHA = 0.85  # Less aggressive for accel (higher = more responsive)
