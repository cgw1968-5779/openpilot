...
confs = [
  ...
  {'name': 'dp_auto_shutdown_in', 'default': 15, 'type': 'UInt16', 'min': 0, 'max': 600, 'depends': [{'name': 'dp_auto_shutdown', 'vals': [True]}], 'conf_type': ['param']},
  # service
  ...
  {'name': 'dp_signal_off_delay', 'default': 3.0, 'type': 'Float32', 'min': 0., 'max': 10., 'depends': [{'name': 'dp_lateral_mode', 'vals': [0]}], 'conf_type': ['param', 'struct']},
  {'name': 'dp_lc_min_mph', 'default': 0, 'type': 'UInt8', 'min': 0, 'max': 255, 'depends': [{'name': 'dp_lateral_mode', 'vals': [1,2]}], 'conf_type': ['param', 'struct']},
  # {'name': 'dp_lc_auto_cont', 'default': True, 'type': 'Bool', 'depends': [{'name': 'dp_lateral_mode', 'vals': [2]}], 'conf_type': ['param', 'struct']},
  ...
  # toyota
  {'name': 'dp_toyota_no_min_acc_limit', 'default': True, 'type': 'Bool', 'conf_type': ['param']},
  ...
  {'name': 'dp_toyota_cruise_override', 'default': True, 'type': 'Bool', 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_toyota_cruise_override_at', 'default': 28, 'type': 'Float32', 'depends': [{'name': 'dp_toyota_cruise_override', 'vals': [True]}], 'min': 0, 'max': 50., 'conf_type': ['param', 'struct']},
  {'name': 'dp_toyota_cruise_override_speed', 'default': 16, 'type': 'Float32', 'depends': [{'name': 'dp_toyota_cruise_override', 'vals': [True]}], 'min': 0, 'max': 50., 'conf_type': ['param', 'struct']},
  # hyundai
