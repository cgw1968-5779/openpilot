...
confs = [
  ...
  {'name': 'dp_atl', 'default': 2, 'type': 'UInt8', 'conf_type': ['param', 'struct'], 'update_once': True},
  ...
  {'name': 'dp_toyota_cruise_override_speed', 'default': 20, 'type': 'UInt8', 'min': 5, 'max': 60, 'depends': [{'name': 'dp_accel_profile_ctrl', 'vals': [True]}], 'conf_type': ['param', 'struct']},
