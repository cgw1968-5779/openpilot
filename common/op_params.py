...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'awareness_factor': Param(100., VT.number, 'Multiplier for the awareness times'),
                        'alca_min_speed': Param(30, VT.number, 'Speed limit to start ALC in MPH'),
                        'alca_nudge_required': Param(False, bool, "Require nudge to start ALC"),
                        'autoUpdate': Param(False, bool, 'Whether to auto-update'),
                        'camera_offset': Param(0.05, VT.number, 'Your camera offset to use in lane_planner.py', live=True),
                        ...
                        'rsa_max_speed': Param(0, VT.number, 'Speed limit to ignore RSA in m/s'),
                        'smart_speed': Param(True, bool, 'Whether to use Smart Speed for drives above smart_speed_max_vego'),
                        'smart_speed_max_vego': Param(0, VT.number, 'Speed limit to ignore Smartspeed in m/s'),
                        'spairrowtuning': Param(True, bool, 'INDI Tuning for Corolla Tss2, set steer_up_15 param to True and flash panda'),
