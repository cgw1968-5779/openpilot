...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      profile_mod_pos = [1.0, 0.95, 0.3, 0.03]
      ...
      y_dist = [1.25, 1.3, 1.34, 1.35, 1.35, 1.322, 1.272, 1.21, 1.1, 1.1, 1.15, 1.2]
      profile_mod_pos = [1.0, 1.2, 1.8, 3.0]
      ...
      profile_mod_pos = [1.0, 1.05, 1.1, 1.1]
