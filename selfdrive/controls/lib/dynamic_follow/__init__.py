...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == self.df_profiles.far:
      y_dist = [1.3781, 1.3932, 1.4218, 1.4536, 1.485, 1.5229, 1.5819, 1.6203, 1.7238, 1.8231, 1.8379, 1.8495, 1.8535]  # TRs
      ...
      y_dist = [1.3781, 1.3895, 1.4, 1.3634, 1.3145, 1.318, 1.3485, 1.257, 1.2288, 1.2288, 1.2288, 1.2288]
      profile_mod_pos = [1.15, 1.55, 2.6, 3.75]
      profile_mod_neg = [0.84, .275, 0.1, 0.05]
    elif df_profile == self.df_profiles.normal:  # default to relaxed/stock
      y_dist = [1.3781, 1.3895, 1.406, 1.421, 1.444, 1.474, 1.516, 1.534, 1.546, 1.568, 1.579, 1.593, 1.614]
