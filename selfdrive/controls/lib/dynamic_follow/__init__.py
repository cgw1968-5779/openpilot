...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      y_dist = [1.2, 1.2, 1.25, 1.28, 1.3, 1.3, 1.27, 1.225, 1.1, 1.1, 1.15, 1.2]
      ...
      y_dist = [1.2, 1.2, 1.3, 1.4, 1.444, 1.477, 1.514, 1.537, 1.6, 1.65, 1.663, 1.675, 1.7]
      profile_mod_pos = [1.08, 1.1, 1.0, 0.65]
