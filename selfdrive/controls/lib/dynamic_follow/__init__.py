...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == self.df_profiles.far:
      y_dist = [1.7238, 1.7238, 1.6203, 1.6203, 1.5229, 1.5229, 1.5819, 1.6203, 1.7238, 1.8231, 1.8379, 1.8495, 1.8535]  # TRs
      ...
      y_dist = [1.3781, 1.3791, 1.3457, 1.3134, 1.3145, 1.3, 1.25, 1.2, 1.144, 0.979, 0.9461, 0.9156]
      profile_mod_pos = [1.03, 1.55, 2.6, 3.75]
      profile_mod_neg = [0.84, .275, 0.1, 0.05]
    elif df_profile == self.df_profiles.normal:  # default to relaxed/stock
      y_dist = [1.42, 1.41, 1.406, 1.421, 1.444, 1.474, 1.516, 1.534, 1.546, 1.568, 1.579, 1.593, 1.614]
      profile_mod_pos = [1.1, 1.0, 1.0, 1.0]
