...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.25, 1.25, 1.3, 1.46, 1.6, 1.76, 1.88, 1.96, 2.25, 2.6, 2.7, 2.8, 3.0]  # eliminates double braking
      ...
      y_dist = [1.25, 1.25, 1.25, 1.28, 1.3, 1.3, 1.27, 1.247, 1.216, 1.175, 1.135, 1.1]  # eliminates double braking
      profile_mod_pos = [1.2, 1.5, 3.0, 3.75]
      profile_mod_neg = [0.6, 0.6, 0.6, 0.2]
    elif df_profile == PROFILE_NORMAL:  # default to relaxed/stock
      y_dist = [1.25, 1.25, 1.28, 1.4, 1.444, 1.477, 1.514, 1.537, 1.6, 1.65, 1.663, 1.675, 1.7]  # eliminates double braking
      profile_mod_pos = [1.15, 1.1, 1.0, 0.65]
