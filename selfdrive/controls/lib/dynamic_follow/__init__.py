...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == self.df_profiles.roadtrip:
      ...
      y_dist = [1.3981, 1.3991, 1.3761, 1.3545, 1.3345, 1.3, 1.25, 1.2, 1.144, 0.979, 0.9461, 0.9156]
    elif df_profile == self.df_profiles.relaxed:  # default to relaxed/stock
      y_dist = [1.546, 1.534, 1.516, 1.474, 1.444, 1.474, 1.516, 1.534, 1.546, 1.568, 1.579, 1.593, 1.614]
    else:
    ...
    y = [4.8, 4.0, 3.5, 2.25, 1.9, 1.6, 1.4, 1.25, 1.15, 1.1, 1.1, 1.05, 1.0, 0.9, 0.81, 0.7]  # multiplier values
