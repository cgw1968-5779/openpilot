...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.0, 1.148, 1.3, 1.46, 1.61, 1.75, 1.88, 1.96, 2.25, 2.6, 2.7, 2.8, 3.0]  # linear smooth braking tune for RAV4TSS2
      profile_mod_pos = [1.0, 1.06, 0.4, 0.05]
      ...
      y_dist = [1.0, 1.2, 1.26, 1.29, 1.3, 1.3, 1.27, 1.247, 1.216, 1.175, 1.135, 1.1]  # linear smooth braking tune for RAV4TSS2
      profile_mod_pos = [1.0, 1.9, 3.15, 3.75]
      profile_mod_neg = [0.6, 0.6, 0.6, 0.2]
    elif df_profile == PROFILE_NORMAL:  # default to relaxed/stock
      y_dist = [1.0, 1.125, 1.28, 1.4, 1.444, 1.477, 1.514, 1.537, 1.6, 1.65, 1.663, 1.675, 1.7]  # linear smooth braking tune for RAV4TSS2
      profile_mod_pos = [1.0, 1.2, 1.2, 0.65]
