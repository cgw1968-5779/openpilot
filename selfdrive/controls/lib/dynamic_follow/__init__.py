...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == self.df_profiles.roadtrip:
      y_dist = [1.75, 1.8, 1.85, 1.9, 2.0, 2.1, 2.2, 2.26, 2.43, 2.6, 2.65, 2.7, 2.8]  # TRs
      ...
      y_dist = [1.3781, 1.3791, 1.3457, 1.3134, 1.3145, 1.318, 1.3485, 1.257, 1.144, 1.06, 0.99, 0.97]
    elif df_profile == self.df_profiles.relaxed:  # default to relaxed/stock
      y_dist = [1.5, 1.55, 1.6, 1.65, 1.7, 1.75, 1.8, 1.83, 1.91, 1.977, 1.996, 2.02, 2.1]
    else:
    ...
    y = [4.8, 4.0, 3.5, 2.25, 1.9, 1.6, 1.4, 1.3, 1.25, 1.2, 1.15, 1.05, 1.0, 0.9, 0.81, 0.7]  # multiplier values
