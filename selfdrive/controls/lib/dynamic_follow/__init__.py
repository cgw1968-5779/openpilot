...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      ...
      y_dist = [1.37, 1.37, 1.4, 1.46, 1.6, 1.76, 1.88, 1.96, 2.25, 2.6, 2.7, 2.8, 3.0]
      ...
      profile_mod_neg = [0.9, 0.8, 0.7, 0.6]
      ...
      y_dist = [1.37, 1.37, 1.4, 1.4, 1.444, 1.477, 1.514, 1.537, 1.6, 1.65, 1.663, 1.675, 1.7]
      profile_mod_pos = [1.05, 1.2, 1.1, 1.1]
