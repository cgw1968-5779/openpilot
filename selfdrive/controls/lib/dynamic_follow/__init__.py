...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == self.df_profiles.far:
      y_dist = [1.3, 1.3832, 1.4218, 1.4536, 1.485, 1.5229, 1.5819, 1.6203, 1.7238, 1.8231, 1.8379, 1.8495, 1.8535]  # TRs
      ...
      y_dist = [1.3, 1.354, 1.4, 1.3634, 1.3145, 1.318, 1.3485, 1.257, 1.2288, 1.2288, 1.2288, 1.2288]
