...
STARTING_BRAKE_RATE = 0.7  # brake_travel/s while releasing on restart
BRAKE_STOPPING_TARGET = 0.69  # apply at least this amount of brake to maintain the vehicle stationary
