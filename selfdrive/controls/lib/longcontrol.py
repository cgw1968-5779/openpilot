...
STOPPING_BRAKE_RATE = 0.25 # brake_travel/s while trying to stop
STARTING_BRAKE_RATE = 1.0  # brake_travel/s while releasing on restart
BRAKE_STOPPING_TARGET = 0.95  # apply at least this amount of brake to maintain the vehicle stationary
