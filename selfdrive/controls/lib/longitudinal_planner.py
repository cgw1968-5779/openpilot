...
_DP_CRUISE_MIN_V =       [-0.94, -0.95, -0.95, -0.95, -0.95, -0.95]
_DP_CRUISE_MIN_V_ECO =   [-0.92, -0.93, -0.93, -0.93, -0.93, -0.90]
_DP_CRUISE_MIN_V_SPORT = [-0.96, -1.98, -0.98, -0.98, -0.98, -0.98]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        ...
        y_dist = [0.80,  0.80, 0.83,  0.83, 0.86,  0.86,  0.93,  0.93,  1.02,  1.02,   1.15,   1.23]
