...
_DP_CRUISE_MIN_V =       [-0.83, -0.83, -0.88, -0.95, -0.95, -0.95]
_DP_CRUISE_MIN_V_ECO =   [-0.82, -0.82, -0.86, -0.86, -0.93, -0.90]
_DP_CRUISE_MIN_V_SPORT = [-0.84, -0.84, -0.92, -0.92, -0.98, -0.98]
_DP_CRUISE_MIN_BP =      [0.,    8.3,   14,    20.,   30.,   55.]

_DP_CRUISE_MAX_V =       [3.5, 3.5, 3.0, 2.0, 1.06, 0.90, 0.68, 0.45, 0.34, 0.13]
_DP_CRUISE_MAX_V_ECO =   [3.4, 3.1, 1.7, 1.2, .76, .62,  .48,  0.36, 0.28, 0.09]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        ...
        y_dist = [0.84,  0.84, 0.84,  0.84, 0.84,  0.84,  0.89,  0.89,  1.00,  1.00,   1.14,   1.23]
