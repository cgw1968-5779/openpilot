...
_DP_CRUISE_MIN_V =       [-0.80, -0.80, -0.85, -1.00, -0.90,  -0.80]
_DP_CRUISE_MIN_V_ECO =   [-0.76, -0.76, -0.80, -0.90, -0.80,  -0.70]
_DP_CRUISE_MIN_V_SPORT = [-0.84, -0.84, -0.90, -1.05, -1.00,  -0.90]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        ...
        y_dist = [0.80,  0.80, 1.11,  1.11,  1.16,   1.16,   1.21,   1.23]
