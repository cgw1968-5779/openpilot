...
_DP_CRUISE_MIN_V =       [-0.55, -0.55, -0.55, -0.65, -0.8,  -0.5]
_DP_CRUISE_MIN_V_ECO =   [-0.50, -0.5,  -0.5,  -0.6,  -0.7,  -0.45]
...
_DP_CRUISE_MAX_V_ECO =   [3.3, 1.8, 1.3, 1.0, 0.71, 0.59, 0.45, 0.36, 0.28, 0.09]
