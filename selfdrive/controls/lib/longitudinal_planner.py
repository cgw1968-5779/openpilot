...
_DP_CRUISE_MIN_V =       [-0.05,  -0.05,  -0.4,  -0.7,  -0.8,  -0.8,  -0.5]
_DP_CRUISE_MIN_V_ECO =   [-0.04,  -0.04,  -0.3,  -0.6,  -0.7,  -0.7,  -0.45]
_DP_CRUISE_MIN_V_SPORT = [-0.08,  -0.08,  -0.5,  -0.8,  -0.9,  -0.9,  -0.6]
_DP_CRUISE_MIN_BP =      [0.,     3.,     8.3,   11,    20.,   30.,   55.]

_DP_CRUISE_MAX_V =       [3.5, 3.4, 2.1, 1.7, 1.2, 0.91, 0.69, 0.45, 0.34, 0.13]
_DP_CRUISE_MAX_V_ECO =   [3.4, 3.1, 1.7, 1.3, .76, .62,  .48,  0.36, 0.28, 0.09]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        ...
        y_dist = [1.0,  1.1,  1.2,    1.21,    1.22,   1.23,   1.34]
