...
_DP_CRUISE_MAX_V =       [3.5, 3.5, 3.5, 3.0, 1.5, 0.90, 0.68, 0.45, 0.34, 0.13]
_DP_CRUISE_MAX_V_ECO =   [3.5, 3.5, 3.5, 2.5, 1.2, .72,  .53,   0.36, 0.28, 0.09]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        x_vel =  [0.0,   3.0,  3.01,  9.0,   9.01,  12.0,  12.01,  19.7,  25.0,  41.67]
        y_dist = [0.85,  0.85, 0.86,  0.86,  0.89,  0.89,  1.00,  1.00,   1.14,   1.23]
