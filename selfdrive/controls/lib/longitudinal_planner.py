...
_DP_CRUISE_MIN_V_SPORT = [-0.08,  -0.08,  -0.6,  -0.8,  -0.9,  -0.9,  -0.6]
_DP_CRUISE_MIN_BP =      [0.,     3.,     8.3,   11,    20.,   30.,   55.]

_DP_CRUISE_MAX_V =       [3.5, 3.5, 2.8, 2.2, 1.6, 1.0, 0.72, 0.45, 0.34, 0.13]
_DP_CRUISE_MAX_V_ECO =   [3.5, 3.4, 2.0, 1.6, .90, .70,  .52,  0.36, 0.29, 0.095]
