...
_DP_CRUISE_MAX_V =       [3.5, 3.5, 3.5, 3.0, 1.8, 1.0, 0.68, 0.45, 0.35, 0.14]
_DP_CRUISE_MAX_V_ECO =   [3.5, 3.5, 3.5, 2.5, 1.2, .72, 0.53, 0.36, 0.28, 0.09]
_DP_CRUISE_MAX_V_SPORT = [3.5, 3.5, 3.5, 3.5, 2.6, 2.1, 1.35, 0.90, 0.70, 0.5]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        ...
        y_dist = [0.88,  0.88,  1.1,  1.1,  1.15,  1.22]
        ...
        y_dist = [0.88, 0.88,  1.2,  1.3,    1.45 ]
        desired_tf = np.interp(v_ego, x_vel, y_dist)
      elif self.dp_following_profile == 2:
        x_vel =  [0.0,  3.0,   12.0,  19.7,   41.67]
        y_dist = [0.88, 0.88,  1.4,   1.5,   1.6]
        desired_tf = np.interp(v_ego, x_vel, y_dist)
    return desired_tf
