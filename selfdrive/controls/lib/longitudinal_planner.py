...
_DP_CRUISE_MIN_V =       [-0.50, -0.50, -0.50, -0.65, -0.6,  -0.5]
_DP_CRUISE_MIN_V_ECO =   [-0.45, -0.45, -0.45, -0.55, -0.50, -0.45]
_DP_CRUISE_MIN_V_SPORT = [-0.60, -0.60, -0.60, -0.75, -0.8,  -0.6]
_DP_CRUISE_MIN_BP =      [0.,    8.3,   14,    20.,   30.,   55.]

_DP_CRUISE_MAX_V =       [3.5, 3.4, 2.1, 1.6, 1.1, 0.91, 0.69, 0.44, 0.34, 0.13]
_DP_CRUISE_MAX_V_ECO =   [3.3, 2.6, 1.6, 1.0, 0.71, 0.59, 0.45, 0.36, 0.28, 0.09]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        x_vel =  [1.1,  3.3,  5.5,  13.9,  19.7,   25.0,   41.67]
        y_dist = [1.0,  1.2,  1.3,  1.32,  1.33,   1.25,   1.34]
