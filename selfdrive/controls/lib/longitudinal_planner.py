...
_DP_CRUISE_MIN_V =       [-0.99, -0.99, -0.15, -0.15, -0.40, -0.40, -1.00]
_DP_CRUISE_MIN_V_ECO =   [-0.99, -0.99, -0.10, -0.10, -0.35, -0.35, -1.00]
_DP_CRUISE_MIN_V_SPORT = [-0.99, -0.99, -0.20, -0.20, -0.45, -0.45, -1.00]
_DP_CRUISE_MIN_BP =      [0.,    3.11,   3.12,  10.,  10.01, 20.,   30.,   55.]

_DP_CRUISE_MAX_V =       [3.0, 3.0, 3.0, 2.0, 1.4, 1.1, 0.75, 0.55, 0.35, 0.14]
_DP_CRUISE_MAX_V_ECO =   [3.0, 3.0, 3.0, 2.0, 1.2, .76, 0.56, 0.36, 0.28, 0.09]
_DP_CRUISE_MAX_V_SPORT = [3.0, 3.0, 3.0, 2.0, 1.6, 1.5, 1.35, 0.90, 0.70, 0.5]
