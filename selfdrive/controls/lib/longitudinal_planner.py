...
_DP_CRUISE_MIN_V =       [-0.80,  -0.45,  -0.50, -0.50,  -0.45, -0.40, -0.40]
_DP_CRUISE_MIN_V_ECO =   [-0.70,  -0.40,  -0.40, -0.40,  -0.40, -0.35, -0.35]
_DP_CRUISE_MIN_V_SPORT = [-0.90,  -0.60,  -0.60, -0.55,  -0.50, -0.45, -0.40]
  ...
  def get_df(self, v_ego):
    ...
    if self.dp_following_profile_ctrl:
      if self.dp_following_profile == 0:
        x_vel =  [3.0,   3.1,   7.556,   13.89,  25.0,   41.67]
