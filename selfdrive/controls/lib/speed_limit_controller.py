...
_LIMIT_PERC_OFFSET_V = [0.0,  .0000, .1,    0.0,   -.01,  0.15, 0.0,   0.0,   .1,    0.,    -.01,  0.1429, 0.,   0.00,  -.04,  .110,  .110,  0,     -.01, .095, .00,  .095, .0000, .09,  .083]
_LIMIT_PERC_OFFSET_BP = [0.0, 10.83, 11.11, 11.39, 13.61, 13.9, 14.17, 16.39, 16.67, 16.94, 19.2,  19.4,  19.72, 21.67, 21.94, 22.22, 22.6,  22.61, 24.6, 25.0, 27.5, 27.8, 30.28, 30.6, 33.3333] 
                        # 0,  40,    44,    41,    50,    57,   51,    59,    66,    61,    69,    80,    71,    79,    79,    90,    90,    82,    89,   99,   100,  110,  110,   120,  130 kph
