...
_LIMIT_PERC_OFFSET_V = [0.0,  .0256, .1,    0.0,   .000,  .16,  0.00,  0.0,   .1,    0.,    0.,    .1429, 0.,    0.00,  .000,  .110,  .100,  0,     0,    .095, .00,  .088, .00,   .09,  .083]
_LIMIT_PERC_OFFSET_BP = [0.0, 10.83, 11.11, 11.39, 13.6,  13.9, 14.17, 16.38, 16.67, 16.94, 19.16, 19.4,  19.72, 21.67, 21.92, 22.22, 22.6,  22.7,  24.7, 25.0, 27.4, 27.8, 30.2,  30.6, 33.3333] 
