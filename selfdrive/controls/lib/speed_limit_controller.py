...
_LIMIT_PERC_OFFSET_V = [0.0,  .0256, .1,    0.0,   .000,  .16,  0.00,  0.0,   .1,    0.,    0.,    .1429, 0.,    0.00,  .000,  .110,  .110,  0,     0,    .095, .01,  .088, .0092, .09,  .083]
_LIMIT_PERC_OFFSET_BP = [0.0, 10.83, 11.11, 11.39, 13.61, 13.9, 14.17, 16.39, 16.67, 16.94, 19.2,  19.4,  19.72, 21.67, 21.94, 22.22, 22.6,  22.8,  24.6, 25.0, 27.5, 27.8, 30.28, 30.6, 33.3333] 
