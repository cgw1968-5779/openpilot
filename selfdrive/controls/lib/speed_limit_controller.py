...
_LIMIT_PERC_OFFSET_V = [0.0,  .0256, .1,    0.0,   .02,   .2,   0.0,   0.0,   .1,    0.,    0.,    .1429, 0.,    0.00,  .00,  .122,   0,     0,     .095, .01,  .095, .0092, .09,  .083]
_LIMIT_PERC_OFFSET_BP = [0.0, 10.83, 11.11, 11.39, 13.61, 13.9, 14.17, 16.39, 16.67, 16.94, 19.2,  19.4,  19.72, 21.67, 22.22, 22.23, 22.50, 24.72, 25.0, 27.5, 27.8, 30.28, 30.6, 33.3333] 
                        # 0,  40,    44,    41,    50,    60,   51,    59,    66,    61,    69,    80,    71,    79,    79,    90,    81,    89,    99,   100,  110,  110,   120,  130 kph
                        # 0,  39,    40,    41,    49,    50,   51,    59,    60,    61,    69,    70,    71,    78,    79,    80,    81,    89,    90,   99,   100,  109,   110,  120 kph
