...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.9, 0.7, 0.7, 0.64, 0.56, 0.52, 0.31, 0.30, 0.27, 0.25, 0.24, 0.24, 0.23, 0.22, 0.22, 0.21, 0.20, 0.20]
      ...
      #km/h[0,   5,    10,    15,   19,  22,   25,     29,      36,      43,   54,    64,    72,    87,    104,   117,  128  144]
      y = [1.2, 1.0, 0.9, 0.8, 0.71, 0.63, 0.6229, 0.61784, 0.60765, 0.58, 0.596, 0.609, 0.625, 0.638, 0.55, 0.4521, 0.52,0.45]
