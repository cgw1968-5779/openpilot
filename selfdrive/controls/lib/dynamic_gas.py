...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      #km/h[0,   5,    10,    15,   19,  22,   25,     29,      36,      43,   54,    64,    72,    87,    104,   117,  128  144]
      y = [0.78, 0.67, 0.63, 0.50, 0.53, 0.53, 0.5229, 0.51784, 0.50765, 0.48, 0.496, 0.509, 0.525, 0.638, 0.45, 0.421, 0.42,0.35]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,   15,   19,  22,   25,   29,   36,   43,   54,   64,   72,   87,   104,  117,  128   144]
      y = [0.7, 0.5, 0.48, 0.43, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.321, 0.27, 0.27]
