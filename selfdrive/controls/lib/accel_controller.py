...
_DP_CRUISE_MIN_V =       [-0.04,  -0.765, -0.765,  -0.80, -0.80, -0.75, -0.70]
_DP_CRUISE_MIN_V_ECO =   [-0.04,  -0.760, -0.760,  -0.76, -0.76, -0.70, -0.65]
_DP_CRUISE_MIN_V_SPORT = [-0.04,  -0.770, -0.770,  -0.90, -1.00, -0.90, -0.80]
_DP_CRUISE_MIN_BP =      [0.,     .1,      15.66,  17.88, 20.,   30.,   55.]
#DP_CRUISE_MIN_BP in mph=[0.,     18,     35,    40,    45,    67,    123]

_DP_CRUISE_MAX_V =       [3.4, 2.9, 1.9, 1.4, 1.06, .88, .68,  .42, .34, .12]
_DP_CRUISE_MAX_V_ECO =   [3.3, 2.8, 1.6, 1.2, .76,  .62, .48,  .33, .28, .085]
