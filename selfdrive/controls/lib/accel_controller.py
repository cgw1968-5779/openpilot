...
_DP_CRUISE_MIN_V =       [-0.740, -0.740,  -0.80, -0.80, -0.80, -0.80]
_DP_CRUISE_MIN_V_ECO =   [-0.730, -0.730,  -0.76, -0.76, -0.76, -0.76]
_DP_CRUISE_MIN_V_SPORT = [-0.750, -0.750,  -0.90, -0.90, -0.90, -0.90]
...
_DP_CRUISE_MAX_V_SPORT = [3.5, 3.5, 3.5, 3.2, 2.4,  2.0,  1.3, 1.0,  .8,  .6]
