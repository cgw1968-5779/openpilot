...
_DP_CRUISE_MIN_V =       [-.92,  -.85,  -.765,  -.765,  -.765,  -.70,  -.65]
_DP_CRUISE_MIN_V_ECO =   [-.88,  -.78,  -.745,  -.745,  -.745,  -.65,  -.65]
_DP_CRUISE_MIN_V_SPORT = [-1.0,  -.87,  -.785,  -.785   -.785,  -.75,  -.65]
_DP_CRUISE_MIN_BP =      [0.,     .1,     2.,    5.,    11.,   20.,   40.]

_DP_CRUISE_MAX_V =       [2.9, 2.9, 2.9, 2.4, 1.8,  .81,  .67,  .42,  .348, .12]
_DP_CRUISE_MAX_V_ECO =   [2.4, 2.4, 2.4, 2.4, 1.4,  .78,  .58,  .376, .323, .083]
_DP_CRUISE_MAX_V_SPORT = [3.4, 3.4, 3.4, 2.4, 2.1,  .92,  .82,  .65,  .40,  .2]
