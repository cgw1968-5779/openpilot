...
def set_lat_tune(tune, name):
  if name == LatTunes.INDI_PRIUS:
    ...
    tune.indi.outerLoopGainV = [4.097, 5.08,  7.698, 8.6176, 9.855, 12.795, 14.999]
    tune.indi.timeConstantBP = [6, 8.33, 13.9, 17,  20, 20.01, 23.88, 23.89,  30,  40]
    tune.indi.timeConstantV = [0.19, 0.24, 0.315, 0,365, 0.55, 0.8, 1.3, 1.34, 2.5,  3.2]
