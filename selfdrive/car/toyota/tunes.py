...
def set_lat_tune(tune, name):
  if name == LatTunes.INDI_PRIUS:
    ...
    tune.indi.outerLoopGainV = [4.94,  7.687, 8.603, 9.866, 12.78, 14.96]
    tune.indi.timeConstantBP = [5, 8.33, 13.9, 18,  20,  23.88, 23.89,  30,  40]
    tune.indi.timeConstantV = [0.13, 0.2425, 0.402, 0,56, 0.85, 1.3, 1.5, 1.9,  2.4]
