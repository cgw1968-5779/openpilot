...
def set_lat_tune(tune, name):
  if name == LatTunes.INDI_PRIUS:
    ...
    tune.init('indi')
    tune.indi.innerLoopGainBP = [8.3, 8.4, 12.49, 12.5, 13.9, 16.7, 30]
    tune.indi.innerLoopGainV = [10.6, 5.4, 6.9, 7, 8.8, 10, 12.4, 15]
    tune.indi.outerLoopGainBP = [8.3, 8.4, 12.49, 12.5, 13.9, 16.7, 30]
    tune.indi.outerLoopGainV = [10, 5.1, 6.67, 6.784, 8.607, 9.87, 12.31, 12]
    ...
    tune.init('indi')
    tune.indi.innerLoopGainBP = [8.3, 12.49, 12.5, 13.9, 16.7, 20, 30]
    tune.indi.innerLoopGainV = [4.0, 6.5, 7, 8.8, 10, 12.4, 13, 15]
    tune.indi.outerLoopGainBP = [8.3, 12.49, 12.5, 13.9, 16.7, 20, 30]
    tune.indi.outerLoopGainV = [3.64, 6.24, 6.886, 8.6065, 9.865, 12.18, 12.96, 14.999]
    #tune.indi.outerLoopGainBP = [8.3, 12.49, 12.5, 13.9, 16.7, 20, 30]
    ...
    tune.indi.timeConstantBP = [1, 8.3, 11.1, 13.9, 16.7, 19.4, 30]
    tune.indi.timeConstantV = [0.33, 0.33, 0.36, 0,41, 0.46, 0.51, 1.4]
    tune.indi.actuatorEffectivenessBP = [1, 16.7, 25, 33]
    tune.indi.actuatorEffectivenessV = [15, 15, 15, 7.5]
