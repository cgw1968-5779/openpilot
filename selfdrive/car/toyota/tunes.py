...
def set_lat_tune(tune, name):
  if name == LatTunes.INDI_PRIUS:
    ...
    tune.indi.outerLoopGainV = [4.16, 5.098,  7.698, 8.6174, 9.845, 12.795, 14.999]
    tune.indi.timeConstantBP = [3, 8.33, 13.9, 17,  20, 20.01, 23.88, 23.89,  30,  40]
    tune.indi.timeConstantV = [0.24, 0.2435, 0.313, 0,362, 0.55, 0.8, 1.3, 1.34, 2.5,  3.2]
