...
def set_lat_tune(tune, name):
  if name == LatTunes.INDI_PRIUS:
    ...
    tune.init('indi')
    tune.indi.innerLoopGainBP = [0.,   8.3,   12.10, 12.11,  13.9,  16.7,  20,   30]
    tune.indi.innerLoopGainV = [7.4,   7.4,   7.5,   7.8,    8.8,   10,    12.8, 15]
    tune.indi.outerLoopGainBP = [0.,   8.3,   12.10, 12.11,  13.9,  16.7,  20,   30]
    tune.indi.outerLoopGainV = [7.055, 7.055, 7.155, 7.6857, 8.607, 9.865, 12.78, 14.999]
