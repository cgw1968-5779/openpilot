...
def set_lat_tune(tune, name):
  if name == LatTunes.INDI_PRIUS:
    ...
    tune.indi.outerLoopGainV = [4.955,  7.6857, 8.605, 9.868, 12.78, 14.999]
    tune.indi.timeConstantBP = [8.32, 8.33, 13.9, 18,  20,  23.88, 23.89,  30]
    tune.indi.timeConstantV = [0.2, 0.2425, 0.4, 0,57, 0.8, 0.95, 1.2, 1.5]
    tune.indi.actuatorEffectivenessBP = [10, 11, 11.1, 25, 33]
    tune.indi.actuatorEffectivenessV = [8, 12, 15, 15, 15]
