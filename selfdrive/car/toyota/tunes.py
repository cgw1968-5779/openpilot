...
def set_lat_tune(tune, name):
  if name == LatTunes.INDI_PRIUS:
    ...
    tune.indi.outerLoopGainV = [4.96,  7.686, 8.605, 9.868, 12.78, 14.96]
    tune.indi.timeConstantBP = [20,  23.88, 23.89,  30,  40]
    tune.indi.timeConstantV = [1.0, 1.3, 1.5, 1.9,  2.4]
    #tune.indi.timeConstantBP = [8.33, 13.9, 18,  20,  23.88, 23.89,  30,  40]
    #tune.indi.timeConstantV = [0.2425, 0.4, 0,57, 0.9, 1.3, 1.5, 1.9,  2.4]
