...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.PRIUS:
      ...
      #set_lat_tune(ret.lateralTuning, LatTunes.TORQUE, MAX_TORQUE=2.512628, FRICTION=0.053784)
      #set_lat_tune(ret.lateralTuning, LatTunes.TORQUE, MAX_TORQUE=2.625504, FRICTION=0.127570)
    ...
    ret.enableBsm = True #0x3F6 in fingerprint[0] and candidate in TSS2_CAR
